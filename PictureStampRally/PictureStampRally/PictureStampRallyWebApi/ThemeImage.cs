...
namespace PictureStampRally
{
    internal partial class ThemeImage : IServiceOperations<PictureStampRallyWebApi>, IThemeImage
    {
        ...
        /// </param>
        internal ThemeImage(PictureStampRallyWebApi client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> PostWithOperationResponseAsync(Stream file, int eventId, string hintAddr, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (file == null)
            {
            ...
            if (hintAddr == null)
            {
                throw new ArgumentNullException("hintAddr");
            }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> PutWithOperationResponseAsync(Stream file, int themeImageId, string hintAddr, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (file == null)
            {
